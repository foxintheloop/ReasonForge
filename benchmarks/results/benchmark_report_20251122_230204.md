...
|----------|----------|--------------|-------------|------------|
| **reasonforge** | **100.0%** | 107/107 | 16ms | $0.0000 |
...
|---------|----------|--------|--------------|------|----------|
| expr_001 | reasonforge | ✓ PASS | 0 | $0.000000 | Symbolically equivalent |
| expr_002 | reasonforge | ✓ PASS | 0 | $0.000000 | Exact numeric match: 3.0 |
| expr_003 | reasonforge | ✓ PASS | 1 | $0.000000 | Symbolically equivalent |
| expr_004 | reasonforge | ✓ PASS | 0 | $0.000000 | Exact string match |
| expr_005 | reasonforge | ✓ PASS | 11 | $0.000000 | Symbolically equivalent |
| expr_006 | reasonforge | ✓ PASS | 2 | $0.000000 | Symbolically equivalent |
| expr_007 | reasonforge | ✓ PASS | 2 | $0.000000 | Symbolically equivalent |
...
| expr_011 | reasonforge | ✓ PASS | 40 | $0.000000 | Symbolically equivalent (ignoring constant) |
| expr_012 | reasonforge | ✓ PASS | 21 | $0.000000 | Symbolically equivalent |
| expr_013 | reasonforge | ✓ PASS | 16 | $0.000000 | Contains 'x' |
| expr_014 | reasonforge | ✓ PASS | 0 | $0.000000 | Contains 'nonexistent' |
| expr_015 | reasonforge | ✓ PASS | 7 | $0.000000 | Contains '6' |
| alg_001 | reasonforge | ✓ PASS | 7 | $0.000000 | Lists match |
| alg_002 | reasonforge | ✓ PASS | 8 | $0.000000 | Lists match |
| alg_003 | reasonforge | ✓ PASS | 1 | $0.000000 | Contains '2' |
| alg_004 | reasonforge | ✓ PASS | 31 | $0.000000 | Contains '(-3, -4)' |
| alg_005 | reasonforge | ✓ PASS | 0 | $0.000000 | Lists match |
| alg_006 | reasonforge | ✓ PASS | 0 | $0.000000 | Contains 'error' |
| alg_007 | reasonforge | ✓ PASS | 0 | $0.000000 | Contains '-2' |
...
| alg_011 | reasonforge | ✓ PASS | 12 | $0.000000 | Contains '1/2' |
...
| alg_016 | reasonforge | ✓ PASS | 14 | $0.000000 | Value 2.0 >= 1.0 |
...
| analysis_001 | reasonforge | ✓ PASS | 39 | $0.000000 | Contains 'exp(x)' |
| analysis_002 | reasonforge | ✓ PASS | 16 | $0.000000 | Contains 'u(x,t)' |
...
| analysis_007 | reasonforge | ✓ PASS | 200 | $0.000000 | Symbolically equivalent |
| analysis_008 | reasonforge | ✓ PASS | 663 | $0.000000 | Contains 'sqrt(pi)' |
...
| analysis_012 | reasonforge | ✓ PASS | 53 | $0.000000 | Contains 'exp' |
| analysis_013 | reasonforge | ✓ PASS | 12 | $0.000000 | Contains '-1' |
| analysis_014 | reasonforge | ✓ PASS | 0 | $0.000000 | Exact string match |
| analysis_015 | reasonforge | ✓ PASS | 3 | $0.000000 | Symbolically equivalent |
...
| geom_002 | reasonforge | ✓ PASS | 2 | $0.000000 | Contains 'field_' |
| geom_003 | reasonforge | ✓ PASS | 4 | $0.000000 | Contains 'curl' |
| geom_004 | reasonforge | ✓ PASS | 4 | $0.000000 | Contains 'divergence' |
| geom_005 | reasonforge | ✓ PASS | 1 | $0.000000 | Contains '0' |
| geom_006 | reasonforge | ✓ PASS | 5 | $0.000000 | Exact string match |
...
| geom_014 | reasonforge | ✓ PASS | 0 | $0.000000 | Exact string match |
| geom_015 | reasonforge | ✓ PASS | 0 | $0.000000 | Exact numeric match: 2.0 |
| stat_001 | reasonforge | ✓ PASS | 37 | $0.000000 | Symbolically equivalent |
| stat_002 | reasonforge | ✓ PASS | 1 | $0.000000 | Contains '0.' |
| stat_003 | reasonforge | ✓ PASS | 2 | $0.000000 | Contains 't_statistic' |
| stat_004 | reasonforge | ✓ PASS | 342 | $0.000000 | Symbolically equivalent |
| stat_005 | reasonforge | ✓ PASS | 3 | $0.000000 | Contains 'correlation' |
| stat_006 | reasonforge | ✓ PASS | 1 | $0.000000 | Exact string match |
| stat_007 | reasonforge | ✓ PASS | 2 | $0.000000 | Contains 'margin' |
...
| stat_013 | reasonforge | ✓ PASS | 3 | $0.000000 | Contains 'F_statistic' |
| stat_015 | reasonforge | ✓ PASS | 0 | $0.000000 | Contains 'mean' |
| stat_016 | reasonforge | ✓ PASS | 0 | $0.000000 | Contains 'error' |
| phys_001 | reasonforge | ✓ PASS | 22 | $0.000000 | Contains 'equations' |
| phys_002 | reasonforge | ✓ PASS | 2 | $0.000000 | Contains 'hamiltonian' |
| phys_003 | reasonforge | ✓ PASS | 0 | $0.000000 | Contains 'conserved' |
| phys_004 | reasonforge | ✓ PASS | 0 | $0.000000 | Contains 'error' |
| phys_005 | reasonforge | ✓ PASS | 9 | $0.000000 | Contains 'sqrt' |
